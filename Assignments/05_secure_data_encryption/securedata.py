...
if choice == "Home":
    st.subheader("Well come To My Data Encryption System Using Streamlit")
...
# ==**** user registration ****==
    ...
    if st.button("Register"):
        if username and password:
            ...
            st.error("Both fields are requied.")
        ...
        if st.button("login"):
            if username in stored_data and stored_data[username]["password"] == hash_password(password):
                ...
                st.success(f"Wel come {username}!")
            else:
